...
- Hero-Bereich mit echten MTM-Einsatzbildern
- Leistungskarten für Umzug, Möbeltransport, Möbelmontage sowie Entrümpelung und Entsorgung
- Klick auf eine Leistung übernimmt die Auswahl in das Anfrageformular
- Teamfoto als prominenter Vertrauensbereich
- Drei-Schritte-Ablauf
- klassisches Anfrageformular mit Upload-Vorbereitung und Datenschutz-Einwilligung
...
- Kontaktbereich, Abschluss-CTA und kompakter Footer
...
Die bereitgestellten echten Bilder wurden eingebunden und für die Webseite komprimiert:

- Teamfoto mit MTM-Fahrzeugen im Vertrauensbereich
- MTM-Fahrzeug beim Einsatz im Hero- und Kontaktbereich
- Montagefoto für die Leistung Möbelmontage
- Räumungsfoto für Entrümpelung und Entsorgung
- Transportfoto für Transportaufträge
...
components/
  ...
  InquiryForm.tsx            Klassisches Anfrageformular
...
## Anfrageformular und E-Mail-Versand

Formular und Anfrage-Assistent senden ihre Daten an den serverseitigen Route Handler `app/api/anfrage/route.ts`. Der Endpunkt:
...
4. Der Worker-Name muss exakt `mtm-service-website` lauten, weil dieser Name in `wrangler.jsonc` hinterlegt ist.
...
6. Unter **Settings > Variables & Secrets** die Runtime-Secrets für den Formularversand hinterlegen:
...
- Verwendung und Freigabe der bereitgestellten Bilder
...
- Auswahl einer Leistung und Übernahme im Formular
- Assistent einschließlich Zurück-Funktion, Zusammenfassung und Upload
- Formularversand mit echten Cloudflare-Secrets
